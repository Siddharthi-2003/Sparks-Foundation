...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">NEW BANK <img src="logos/logo.webp" alt="Bank" width="50" height="50"></a>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/friend.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Welcoming you in the most trusted New Bank !</strong> <img src="logos/trust.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="background/bankbg1.jpg" width="1000" height="375" class="d-block w-100" alt="...">
            ...
            <div class="carousel-item active">
                <img src="background/Bankbg2.jpg" width="1000" height="375" class="d-block w-100" alt="Customer Service Excellence">
            </div>
            </div>
            <div class="carousel-item">
            <div class="carousel-item active">
                <img src="background/Bankbg3.jpg" width="1000" height="375" class="d-block w-100" alt="Trust and Integrity">
            </div>
            </div>
        </div>
